    ...
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 pb-20 pt-8 lg:px-10 lg:pt-16">
          ...
          <dl className="mt-20 grid max-w-4xl grid-cols-3 gap-8 border-t border-line/70 pt-10">
            <Stat n="40+" label="Projects delivered" />
            <Stat n="1.2M" label="sq. ft. built" />
            <Stat n="80+" label="On-site team" />
          </dl>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pt-24 pb-8 lg:px-10">
        <div className="flex items-end justify-between border-b border-line/70 pb-6">
          ...
          <Link
            href="/projects"
            className="hidden text-[12px] font-semibold uppercase tracking-[0.18em] text-ink/75 transition hover:text-ink md:inline"
          >
            View all →
          </Link>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-[1fr_2fr]">
            <div>
              ...
              <p className="mt-6 max-w-sm text-sm leading-relaxed text-ink/75">
                ...
                design, procurement, quality, and cash-flow in the same room.
              </p>
            </div>
        ...
        <div className="relative overflow-hidden rounded-[36px] bg-ink px-8 py-20 text-paper md:px-16 md:py-28">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-4 text-[12px] font-semibold uppercase tracking-[0.18em] text-ink transition hover:opacity-90"
              >
  ...
  return (
    <Link href={`/projects/${project.slug}`} className="group block">
      <div className="relative aspect-[4/5] overflow-hidden rounded-[24px] bg-bone">
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-bone via-paper-2 to-line/60">
